...
name_form = browser.find_element(By.XPATH,'//*[@id="student_form"]/div/div[1]/input')
name_form.send_keys(classi_login)

pass_form = browser.find_element(By.XPATH,'//*[@id="usr_password"]')
...
for i in range(9):
  ...
  texts = browser.find_element(By.XPATH,'/html/body/study-root/spen-single-column/div/main/study-my-report-form/form/div[2]/div[2]/study-student-message/div/div[2]/div/textarea')
  texts.clear()
